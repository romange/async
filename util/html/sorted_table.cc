...
struct THFormatter {
  ...
  void operator()(string* out, absl::string_view str) const {
...
void SortedTable::StartTable(const std::vector<absl::string_view>& header, string* dest) {
...
void SortedTable::Row(const std::vector<absl::string_view>& row, std::string* dest) {
